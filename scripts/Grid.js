...
var _Grid_numRow, _Grid_numCol, _Grid_grid, _Grid_coolDown, _Grid_dropTime, _Grid_bonusScoreRate, _Grid_dropInterval;
class Grid {
    /**
    ...
    constructor(row, column, element) {
        ...
        _Grid_bonusScoreRate.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _Grid_bonusScoreRate, 1.0, "f");
    ...
    //     this.#mergeStreak = ms;
    // }
    setBonusScoreRate(bsr) {
        __classPrivateFieldSet(this, _Grid_bonusScoreRate, bsr, "f");
    }
    //Getter Method(s)
    getCoolDown() {
    ...
    // }
    getBonusScoreRate() {
        return __classPrivateFieldGet(this, _Grid_bonusScoreRate, "f");
    }
}
_Grid_numRow = new WeakMap(), _Grid_numCol = new WeakMap(), _Grid_grid = new WeakMap(), _Grid_coolDown = new WeakMap(), _Grid_dropTime = new WeakMap(), _Grid_bonusScoreRate = new WeakMap(), _Grid_dropInterval = new WeakMap();
/*
